...
public class EndtoEnd extends BaseTest{
	...
	@Test(description="Invalid Credential", priority=1)
    ...
    public void Product1() throws InterruptedException {
		...
		product1.Product1();
		test.log(Status.PASS, "User has added First Product");
    ...
    public void Product2() throws InterruptedException {
		...
		product2.Product2();
		test.log(Status.PASS, "User has added Second Product");
    ...
    public void Checkout() throws InterruptedException {
		...
		checkout.Checkout();
		test.log(Status.PASS, "User has Checkout Successfully");
		test.info("User has Checkout Successfully & Order placed Successfully");
    }
	
	@Test(description="User Informations are Required ", priority=11)
    public void UserInformation() throws InterruptedException {
        test = extent.createTest("User Informations are Required !");
		CheckoutPage requirefields = new CheckoutPage(driver);    
		requirefields.UserInformation();
		test.log(Status.PASS, "Validations are Required");
		test.info("Fields are Required");
    }
